...
<div class="login-container">
                    ...
                    <div class="step current" id="step-2">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input id="username" type="text" class="form-control{{$errors->has('username')?'is-invalid':''}}" name="username" value="{{old('username')}}" placeholder="Username" data-mask="[a-zA-Z0-1\.]+" data-is-regex="true" autocomplete="off">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <div class="input-group">
                                ...
                                <input id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" required data-mask="email" placeholder="E-mail" autocomplete="off">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <div class="input-group">
                                ...
                                <input id="password" type="password" class="form-control" placeholder="Choose Password" autocomplete="off" name="password" required>
                        ...
                        <div class="form-group">
                            <button type="submit" onclick="show_loading_bar(100);" class="btn btn-success btn-block btn-login">
                                <i class="entypo-right-open-mini"></i>
    ...
    <script src="{{asset('neon/')}}/html/neon/assets/js/neon-register.js"></script>
    <script src="{{asset('neon/')}}/html/neon/assets/js/jquery.inputmask.bundle.js"></script>

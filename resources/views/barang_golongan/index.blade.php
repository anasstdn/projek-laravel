    ...
    <div class="row push">
      <div class="col-md py-10 d-md-flex align-items-md-center text-center">
        <h1 class="text-white mb-0">
          <span class="font-w300">Golongan Barang</span>
        </h1>
      </div>
    </div>
  </div>
...
<div class="bg-white">
	...
	<div class="content">
		<nav class="breadcrumb mb-0">
			...
			<span class="breadcrumb-item active">Golongan Barang</span>
		</nav>
	</div>
		...
		<div class="block">
				<div class="row col-lg-12" style="margin-bottom:1em;font-family: sans-serif;">
					...
					<div class="col-md-2 text-right">
							<a class="btn btn-sm btn-primary data-modal pull-left" style="color: white" id="data-modal" href="#" onclick="show_modal('{{ route('barang-golongan.create') }}')" ><i class='si si-plus' style="color: white" aria-hidden='true'></i> Tambah Data</a>
					</div>
				</div>
			<div class="block-content block-content-full">
				...
				<div id="table_data">
					@include('barang_golongan.index-data')
				</div>
			</div>
		</div>
...
function fetch_data(page)
{
	...
	$.ajax({
		url:"{{url('barang-golongan/get-data')}}?page="+page,
		data:data_ajax,
		headers: {
